...
\setminted[javascript]{bgcolor=orange!5, linenos, breakanywhere=true}
%定义新的minted命令
\newminted[js]{javascript}{}

\setminted[HTML]{bgcolor=blue!5!white, linenos, breakanywhere=true}
\newminted[html]{HTML}{}


\title{\textbf{Learning Everything}}
